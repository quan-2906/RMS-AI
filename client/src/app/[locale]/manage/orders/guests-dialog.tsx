...
export default function GuestsDialog({
  ...
  const getGuestListQuery = useGetGuestListQuery({
    fromDate,
    toDate,
  });
  const data = getGuestListQuery.data?.payload.data ?? [];
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent className="sm:max-w-[700px] max-h-full overflow-auto">
        <AlertDialogHeader>
          <AlertDialogTitle>Chọn khách hàng</AlertDialogTitle>
        </AlertDialogHeader>
        <div>
